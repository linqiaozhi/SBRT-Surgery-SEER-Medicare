...
label_list  <-  list(
                     ...
                     death.noncopd.nonheart.nonstroke = '*Other non-lung cancer mortality*',
                     death.other.1 = '*Composite placebo 1*',
                     death.other.2 = '*Composite placebo 2*',
                     death.other.3 = '*Composite placebo 3*',
                     death.other.4 = '*Composite placebo 4*',
                     age = 'Age',
                     sex = 'Male Sex',
                     race = 'Race',
                     race2 = 'Race',
                     ...
                     histology =  'Histology',
                     mediastinal.staging =  'Pre-treatment EBUS/Mediastinoscopy',
                     ...
                     smoking_pre_12months_unique_count_bool = 'Smoking',
                     o2_pre_12months_unique_count_bool = 'Oxygen',
                     pneumonia_and_influenza_pre_12months_unique_count_bool = 'Pneumonia and influenza',
                     other_bacterial_diseases_pre_12months_unique_count_bool = 'Other bacterial diseases',
                     pressure_ulcer_pre_12months_unique_count_bool = 'Pressure ulcer',
                     ischemic_heart_disease_pre_12months_unique_count_bool = 'Ischemic heart disease',
                     CHF_pre_12months_unique_count_bool = 'Congestive heart failure',
                     other_heart_disease_pre_12months_unique_count_bool = 'Other heart disease',
                     PVD_pre_12months_unique_count_bool = 'Peripheral vascular disease',
                     CVD_pre_12months_unique_count_bool = 'Cerebrovascular disease',
                     dementia_pre_12months_unique_count_bool = 'Dementia',
                     COPD_pre_12months_unique_count_bool = 'Other chronic pulmonary disease, including COPD',
                     asthma_pre_12months_unique_count_bool = 'Asthma',
                     interstitial_lung_pre_12months_unique_count_bool = 'Interstitial lung disease',
                     other_lung_pre_12months_unique_count_bool = 'Other lung disease',
                     PUD_pre_12months_unique_count_bool = 'Peptic ulcer disease',
                     MILDLD_pre_12months_unique_count_bool = 'Mild liver disease',
                     MSLD_pre_12months_unique_count_bool = 'Moderate or severe liver disease',
                     LD_pre_12months_unique_count_bool = 'Liver disease',
                     DIAB_UC_pre_12months_unique_count_bool = 'Uncomplicated diabetes',
                     DIAB_C_pre_12months_unique_count_bool = 'Complicated diabetes',
                     # PARA_pre_12months_unique_count_bool = 'Paralysis',
                     RD_pre_12months_unique_count_bool = 'Renal disease',
                     # cancer_nonlung_pre_12months_unique_count_bool = 'Cancer (non-lung)',
                     # METS_pre_12months_unique_count_bool = 'Metastatic disease',
                     mental_disorders_pre_12months_unique_count_bool = 'Mental disorders',
                     nervous_system_pre_12months_unique_count_bool = 'Neurological disorders',
                     # veins_lymphatics_other_circulatory_pre_12months_unique_count_bool = 'Veins, lymphatics, other circulatory',
                     mobility_aids_pre_12months_unique_count_bool = 'Mobility aids',
                     dialysis_pre_12months_unique_count_bool = 'Dialysis',
                     echo_pre_12months_unique_count_bool = 'Echocardiogram',
                     stress_test_pre_12months_unique_count_bool = 'Stress test',
                     pft_pre_12months_unique_count_bool = 'PFTs',
                     # rheum_pre_12months_unique_count_bool = 'Rheumatologic diseases',
                     Insulin_pre_12months_unique_count_bool = 'Insulin',
                     Anticoags_pre_12months_unique_count_bool = 'Anticoagulation',
                     # Z
                     O2accessories_pre_12months_unique_count_bool = 'Oxygen accessories',
                     walking_aids_pre_12months_unique_count_bool = 'Walking aids',
                     hospital_beds_and_supplies_pre_12months_unique_count_bool = 'Hospital beds and supplies',
                     wheelchairs_accessories_pre_12months_unique_count_bool = 'Wheelchairs and accessories',
                     transportation_services_pre_12months_unique_count_bool = 'Transportation services',
                     other_supplies_pre_12months_unique_count_bool = 'Other supplies',
                     diabetic_footwear_pre_12months_unique_count_bool = 'Diabetic footwear',
                     # W
                     fall_pre_12months_unique_count_bool = '*Fall*',
                     other_injury_pre_12months_unique_count_bool = '*Other injury*',
                     diverticular_disease_pre_12months_unique_count_bool = '*Diverticular disease*',
                     hernia_pre_12months_unique_count_bool = '*Hernia*',
                     arthropathy_pre_12months_unique_count_bool = '*Arthropathy*',
                     GU_sx_pre_12months_unique_count_bool = '*Genitourinary symptoms*',
                     optho2_pre_12months_unique_count_bool = 'Ophthalmologic disease'
